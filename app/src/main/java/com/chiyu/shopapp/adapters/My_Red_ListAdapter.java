 ...
 * 
 */
public class My_Red_ListAdapter extends BaseAdapter {
	...
	public My_Red_ListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder vh = null;
		if (null == convertView) {
			convertView = inflater.inflate(R.layout.my_red_listitem, null);
...
//				vh.ib_check.setBackgroundResource(R.drawable.zhifu_redbag_sel);
//			} else {
//				vh.ib_check
//						.setBackgroundResource(R.drawable.zhifu_redbag_bg_quan);
//			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
		My_Red_ListAdapter.isSelected = isSelected;
	}
